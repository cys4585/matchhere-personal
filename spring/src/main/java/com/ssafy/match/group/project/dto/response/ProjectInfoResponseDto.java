...
//    @Lob // DBFile 객체 반환시 InvalidDefinitionException: No serializer found for class
    ...
    public static ProjectInfoResponseDto of(Project project) {
        return ProjectInfoResponseDto.builder()
                ...
                .host(new MemberSimpleInfoResponseDto(project.getMember()))
                ...
                .club((project.getClub() == null) ? null : new ClubSimpleInfoResponseDto(project.getClub()))
    ...
    @Builder
    public ProjectInfoResponseDto(Long id, String name, String schedule, int period, MemberSimpleInfoResponseDto host, int developerCount, int developerMaxCount, int designerCount, int designerMaxCount, int plannerCount, int plannerMaxCount, Boolean isPublic, Boolean isParticipate, String city, String status, ClubSimpleInfoResponseDto club, String cover_pic, LocalDateTime modifiedDate, String bio) {
        this.id = id;
        this.name = name;
