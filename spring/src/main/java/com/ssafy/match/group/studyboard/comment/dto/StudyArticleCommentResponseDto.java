package com.ssafy.match.group.studyboard.comment.dto;
...
@Builder
@AllArgsConstructor
public class StudyArticleCommentResponseDto {
    ...
    public static StudyArticleCommentResponseDto from(StudyArticleComment pac){
        return StudyArticleCommentResponseDto.builder()
            .id(pac.getId())
