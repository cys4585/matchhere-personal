...
public class ClubController {
    ...
    public ResponseEntity<ClubInfoResponseDto> create(@Valid @RequestBody ClubCreateRequestDto dto) {
    ...
    @PutMapping("/cover-pic/{clubId}/{uuid}")
    ...
    public ResponseEntity<DBFileDto> changeCoverPic(@PathVariable("clubId") Long clubId,
        @PathVariable("uuid") String uuid) {
        return new ResponseEntity<>(clubService.changeCoverPic(clubId, uuid), HttpStatus.OK);
    }
