...
@AllArgsConstructor
public class StudyArticleInfoResponseDto {
    ...
    public static StudyArticleInfoResponseDto of(StudyArticle studyArticle, List<String> tags) {
        return StudyArticleInfoResponseDto.builder()
