...
public class ProjectUpdateRequestDto {
    ...
    @ApiModelProperty(name = "addStackList", example = "[\"python\",\"java\"]")
    @ApiParam(value = "추가된 기술 스택 리스트", required = true)
    private List<String> addStackList;

    @ApiModelProperty(name = "removeStackList", example = "[\"python\",\"java\"]")
    ...
    @ApiParam(value = "소속된 클럽 id (클럽 변경이 가능하다면) ")
    private Long clubId;
    ...
    @ApiModelProperty(name = "hostRole", example = "디자이너, 개발자, 기획자 중 하나")
